...
It appears that the `us.cities` file includes cities in Hawaii and in Alaska. We will again data transformation commands to  eliminate these four cities and make a final map.
