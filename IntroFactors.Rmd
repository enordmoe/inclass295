...
The following chunk should read the Kaggle study data from the `data` directory in your workspace. You will see some parsing issues which you may or may not wish to explore.  
